    ...
    <div>
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-12 col-md-4">
                ...
                <input type="text" name="size" class="form-control autoDecimal" placeholder="Enter product size" required>
            </div>
            ...
            <div class="col-sm-12 col-md-4">
                ...
                <input type="text" name="quantity" class="form-control autonumber" placeholder="Enter product quantity" required>
            </div>
        </div>
...
<script>
    export default {
        props: ['unitOfMearsurement', 'paymentStatus', 'purchaseExpenses'],
        data() {
            return {
