                        ...
                        <div class="card User-Activity">
                            ...
                            <div class="card-block pb-0">
                                ...
                                @endif
                                    ...
                                    <form method="POST" action="{{ route('business.customers.import-csv', [$business->id]) }}" enctype="multipart/form-data">
                                        @csrf

                                        <div class="mb-5">
                                            Description of format in document;<br>
                                           <b>name|phone number|email address</b>
                                        </div>
