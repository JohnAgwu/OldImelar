                            ...
                            <div class="card-block pb-0">
                                ...
                                @else
                                    <div class="p-5 text-center">
                                        <h4>You have not added a default message for new item.</h4>

                                        <a href="{{ route('business.settings.add-new-item-alert-view', [$business->id]) }}" class="btn text-white label theme-bg btn-shadow">
