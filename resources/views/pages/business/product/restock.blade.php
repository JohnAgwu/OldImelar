                ...
                <div>
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <form method="POST" action="{{ route('business.restock.product', [$business->id, $product->id]) }}" enctype="multipart/form-data">
                                @csrf

                                <restock-product product="{{ $product }}" payment-status="{{ $paymentStatus }}" purchase-expenses="{{ $purchaseExpenses }}" products="{{ $business->products }}">
