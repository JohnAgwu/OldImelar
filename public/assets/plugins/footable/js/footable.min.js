...
!function (a, b) {
    ...
    a.arr = {}, a.arr.each = function (b, c) {
        ...
        for (var f = 0, g = b.length; g > f; f++) if (b[f] == c) {
            d = f, e = b[f];
            break
        }
    ...
    a.str = {}, a.str.contains = function (b, c, d) {
        ...
        for (var e = b.split(/\W/), f = 0, g = e.length; g > f; f++) if (d ? e[f].toUpperCase() == c.toUpperCase() : e[f] == c) return !0;
        return !1
    ...
    b.__extend__ = function (b, d, e, f) {
        ...
        if (d = g.shift(), e = g.shift(), a.is.hash(d)) {
            var h = Object.create(this.prototype), i = this.prototype;
            ...
            return h.construct = a.is.fn(h.construct) ? h.construct : function () {
            }, k.prototype = h, h.constructor = k, k.extend = b.extend, k
        }
        ...
        construct: function () {
            ...
            var e, f, g = this, h = Array.prototype.slice.call(arguments), i = [], j = [];
            b = h.shift() || {};
            for (e in g.registered) if (g.registered.hasOwnProperty(e)) {
            ...
            var e, f = this, g = Array.prototype.slice.call(arguments);
    ...
    b.Cell = b.Class.extend({
        construct: function (a, b, c, d) {
            ...
            var f = this, g = b.is.hash(c) && b.is.hash(c.options) && b.is.defined(c.value);
            if (this.o = a.extend(!0, {
                ...
                var h = this.$detail.children("td").first().empty(), i = b.is.jq(this.$detail.parent()) ? h : this.$el;
            ...
            var c = !b.is.emptyArray(this.column.classes), d = !b.is.emptyArray(this.classes), e = null;
            ...
            var d = !b.is.emptyObject(this.column.style), e = !b.is.emptyObject(this.style), f = null;
    ...
    b.Row = b.Class.extend({
        construct: function (a, b, c) {
            ...
            this.$el = b.is.element(c) || b.is.jq(c) ? a(c) : null, this.$toggle = a("<span/>", {"class": "footable-toggle fa fa-plus"});
            var d = b.is.hash(c), e = d && b.is.hash(c.options) && b.is.hash(c.value);
            ...
            this.collapse(!1);
            var g = b.is.hash(c), h = g && b.is.hash(c.options) && b.is.hash(c.value);
            if (this.o = a.extend(!0, {
                expanded: f.expanded,
                classes: f.classes,
                style: f.style
            }, h ? c.options : {}), this.expanded = this.o.expanded, this.classes = b.is.array(this.o.classes) ? this.o.classes : b.is.string(this.o.classes) ? this.o.classes.match(/\S+/g) : [], this.style = b.is.hash(this.o.style) ? this.o.style : b.is.string(this.o.style) ? b.css2json(this.o.style) : {}, g) if (h && (c = c.value), b.is.hash(this.value)) for (var i in c) c.hasOwnProperty(i) && (this.value[i] = c[i]); else this.value = c; else this.value = null;
    ...
    b.instances = [], b.Table = b.Class.extend({
        construct: function (c, d, e) {
            ...
            return c.raise("init.ft.table").then(function () {
                var d = c.$el.children("thead"), e = c.$el.children("tbody"), f = c.$el.children("tfoot");
            ...
            for (var b = 0, c = this.components.length; c > b; b++) if (this.components[b] instanceof a) return this.components[b];
            return null
        }, draw: function () {
            var a = this, c = a.$el.clone().insertBefore(a.$el);
            ...
            var g = this, h = Array.prototype.slice.call(arguments);
            a = h.shift(), c = h.shift();
            ...
            var g, h = this, i = Array.prototype.slice.call(arguments);
    ...
    b.Breakpoints = b.Component.extend({
        construct: function (a) {
            ...
            if ("all" === a) return !1;
            for (var c = a.split(" "), d = 0, e = c.length; e > d; d++) if (this.cascade ? b.str.containsWord(this.hidden, c[d]) : c[d] == this.current.name) return !1;
            return !0
        }, check: function () {
            var a = this, c = a.get();
    ...
    b.Columns = b.Component.extend({
        construct: function (a) {
            ...
            return a.Deferred(function (c) {
                function e(c, d) {
                    var e = [];
                    if (0 == c.length || 0 == d.length) e = c.concat(d); else {
                        var f = 0;
            ...
            var c = this;
            c.$header = b.is.jq(c.$header) ? c.$header : a("<tr/>", {"class": "footable-header"}), c.$header.children("th,td").detach(), b.arr.each(c.array, function (a) {
    ...
    b.Rows = b.Component.extend({
        construct: function (a) {
            ...
            var e = this, f = a.map(d, function (a) {
            ...
            var a = this, c = a.ft.$el.children("tbody"), d = !0;
            ...
            var e = this, f = a.map(c, function (a) {
                return new b.Row(e.ft, e.ft.columns.array, a)
            });
            b.arr.each(this.array, function (a) {
                a.predraw()
    ...
    a.Filter = a.Class.extend({
        construct: function (b, c, d, e, f, g, h) {
            ...
            var c = this, d = a.arr.map(b.cells, function (b) {
    ...
    b.Filtering = b.Component.extend({
        construct: function (a) {
            ...
            var c, d = this, e = a("<div/>", {"class": "form-group footable-filtering-search"}).append(a("<label/>", {
                    "class": "sr-only",
                    text: "Search"
                })), f = a("<div/>", {"class": "input-group"}).appendTo(e), g = a("<div/>", {"class": "input-group-btn"}),
                h = a("<button/>", {
                    type: "button",
            ...
            }).on("click", {self: d}, d._onSearchButtonClicked).append(a("<span/>", {"class": "fa fa-search"})), d.$dropdown = a("<ul/>", {"class": "dropdown-menu dropdown-menu-right"}), b.is.emptyString(d.dropdownTitle) || d.$dropdown.append(a("<li/>", {
                "class": "dropdown-header",
                text: d.dropdownTitle
            })), d.$dropdown.append(b.arr.map(d.ft.columns.array, function (b) {
                return b.filterable ? a("<li/>").append(a("<a/>", {"class": "checkbox", 'style': 'padding: 5px !important;'}).append(a("<label/>", {html: b.title}).prepend(a("<input/>", {
                    type: "checkbox",
                    checked: !0,
                    style: 'display: block'
            ...
            a ? this.$button.children(".fa").removeClass("fa-times").addClass("fa-search") : this.$button.children(".fa").removeClass("fa-search").addClass("fa-times")
        }, find: function (a) {
            ...
            var c = a.data.self, d = "keypress" == a.type && !b.is.emptyString(String.fromCharCode(a.charCode)),
                e = "keyup" == a.type && (8 == a.which || 46 == a.which), f = "paste" == a.type;
            ...
            if (c.hasClass("fa-close")) b.clear(); else {
                var d = b.$input.val();
            ...
            null != b._filterTimeout && clearTimeout(b._filterTimeout), b._filterTimeout = setTimeout(function () {
                ...
                a.hasClass("fa-times") && (a.removeClass("fa-times").addClass("fa-search"), b.addFilter("search", b.$input.val()), b.filter())
            }, b.delay)
    ...
    a.Query = a.Class.extend({
        construct: function (b, c, d, e) {
            ...
            if (a.is.emptyString(this._original)) this._original = b; else if (this._original == b) return;
            ...
            var d = this, e = !1, f = a.is.emptyString(b);
        ...
        construct: function (a) {
            ...
            this.ft.raise("init.ft.sorting").then(function () {
                ...
                b.arr.each(c.ft.columns.array, function (b) {
                    b.sortable && b.$el.addClass("footable-sortable").append(a("<span/>", {"class": "fa fa-sort"}))
            ...
            if (this.column) {
                var a = this, b = a.ft.$el.find("thead > tr > .footable-sortable"), c = a.column.$el;
                b.removeClass("footable-asc footable-desc").children(".fa").removeClass("fa-sort fa-sort-up fa-sort-down"), b.not(c).children(".fa").addClass("fa-sort"), c.addClass("DESC" == a.column.direction ? "footable-desc" : "footable-asc").children(".fa").addClass("DESC" == a.column.direction ? "fa-sort-down" : "fa-sort-up")
            }
        }, sort: function (a, b) {
            ...
            var e = this, f = new b.Sorter(e.ft.columns.get(c), b.Sorting.dir(d));
            ...
            var c = b.data.self, d = a(this).closest("th,td"),
    ...
    b.Paging = b.Component.extend({
        construct: function (a) {
            ...
            if (this.ft.$el.addClass("footable-paging").addClass(c), this.$container = null === this.container ? null : a(this.container).first(), b.is.jq(this.$container)) this.$container.addClass("footable-paging-external").addClass(c); else {
                var d = this.ft.$el.children("tfoot");
                0 == d.length && (d = a("<tfoot/>"), this.ft.$el.append(d)), this.$row = a("<tr/>", {"class": "footable-paging"}).prependTo(d), this.$container = this.$cell = a("<td/>").attr("colspan", this.ft.columns.visibleColspan).appendTo(this.$row)
            }
            this.$wrapper = a("<div/>", {"class": "footable-pagination-wrapper"}).appendTo(this.$container), this.$pagination = a("<ul/>", {"class": "pagination justify-content-center", role: 'navigation'}).on("click.footable", "a.page-link", {self: this}, this._onPageClicked), this.$count = a("<span/>", {"class": "label label-default"}), this.$wrapper.append(this.$pagination, a("<div/>", {"class": "divider"}), this.$count), this.detached = !1
        }, format: function (a) {
            var b = this.size * (this.current - 1) + 1, c = this.size * this.current;
            ...
            var d = this, e = new b.Pager(d.total, d.current, d.size, c, c > d.current);
            ...
            if (this._createdLinks !== this.total) {
                var b = this, c = b.total > 1, d = function (b, c, d) {
                    return a("<li/>", {"class": d}).attr("data-page", b).append(a("<a/>", {
                        "class": "page-link",
                        href: "#"
                    }).data("page", b).html(c))
                };
                b.$pagination.empty(), c && (b.$pagination.append(d("first", b.strings.first, "page-item")), b.$pagination.append(d("prev", b.strings.prev, "page-item")), b.limit > 0 && b.limit < b.total && b.$pagination.append(d("prev-limit", b.strings.prevPages, "page-item")));
                for (var e, f = 0; f < b.total; f++) e = d(f + 1, f + 1, "footable-page"), b.$pagination.append(e);
                c && (b.limit > 0 && b.limit < b.total && b.$pagination.append(d("next-limit", b.strings.nextPages, "page-item")), b.$pagination.append(d("next", b.strings.next, "page-item")), b.$pagination.append(d("last", b.strings.last, "page-item"))), b._createdLinks = b.total
            }
            ...
            if (b.preventDefault(), !a(b.target).closest("li").is(".active,.disabled")) {
                var c = b.data.self, d = a(this).data("page");
                switch (d) {
                    case"first":
                        return void c.first();
                    case"prev":
    ...
    b.Editing = b.Component.extend({
        construct: function (c) {
            ...
            var b = this, c = "right" === b.position ? "footable-editing-right" : "footable-editing-left";
            ...
            return '<button type="button" class="btn btn-danger footable-delete">' + this.deleteText + "</button>"
        }, $buttonView: function () {
            ...
            c.preventDefault();
            var d = c.data.self, e = a(this).closest("tr").data("__FooTableRow__");
    ...
    b.EditingColumn = b.Column.extend({
        construct: function (a, b, c) {
            ...
            var d = this.editing.$rowButtons(), e = a("<td/>").append(d);
    ...
    b.Defaults.prototype.editing = {
        ...
        showText: '<span class="fa fa-pencil-alt" aria-hidden="true"></span> Edit rows',
        hideText: "Cancel",
        addText: "New row",
        editText: '<span class="fa fa-pencil-alt" aria-hidden="true"></span>',
        deleteText: '<span class="fa fa-trash" aria-hidden="true"></span>',
        viewText: '<span class="fa fa-info" aria-hidden="true"></span>',
        allowAdd: !0,
        allowEdit: !0,
        allowDelete: !0,
        allowView: !1,
        column: {classes: "footable-editing", name: "editing", title: '', filterable: !1, sortable: !1}
    }
}(jQuery, FooTable), function (a, b) {
    ...
    b.Row.prototype.add = function (c) {
        ...
        var c, d = this, e = this._super(a), f = d.ft.use(b.Editing);
        return f && f.pageToNew && (c = d.ft.use(b.Paging)) && a ? e.then(function () {
            var a = c.unpaged.indexOf(d), b = Math.ceil((a + 1) / c.size);
        ...
        return c && e.ft.draw().then(function () {
            ...
            if (b.is.defined(b.Paging) && c && c.pageToNew && (a = e.ft.use(b.Paging))) {
                var d = a.unpaged.indexOf(e), f = Math.ceil((d + 1) / a.size);
    ...
    a.Rows.prototype.add = function (b, c) {
        ...
        var e = this.ft.rows.all.length, f = b;
        ...
        var d = this.ft.rows.all.length, e = b;
    ...
    b.Export = b.Component.extend({
        construct: function (a) {
            ...
            var c = a ? this.ft.rows.all : this.snapshot, d = [];
